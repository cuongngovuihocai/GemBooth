...
export default function App() {
  ...
  if (!apiKey) {
    return (
      <main className="apiKeyScreen">
        <h1>💎 GemBooth</h1>
        <p>
          Để sử dụng ứng dụng này, bạn cần có <b>Gemini API Key</b> từ Google AI Studio.
        </p>
        <input
          type="password"
        ...
        <div style={{display: 'flex', gap: '10px'}}>
             <a href="https://aistudio.google.com/app/apikey" target="_blank" className="button" style={{background: '#333'}}>
               Lấy API Key
            </a>
            <button 
                className="button apiKeySubmit" 
